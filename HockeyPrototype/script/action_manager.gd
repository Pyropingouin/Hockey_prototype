...
## AI ACTIONS
func ai_attempt_move(active_ai_pawn, starting_cell, destination_cell):
 
  if IceMapLayer.can_move_pawn_to(active_ai_pawn, starting_cell, destination_cell):
    IceMapLayer.apply_move(active_ai_pawn, starting_cell, destination_cell)
    ...
    IceMapLayer.reset_move(active_ai_pawn, starting_cell)
    return false  



func ai_attempt_shoot(target_cell: Vector2i, chosen_ai_pawn):
